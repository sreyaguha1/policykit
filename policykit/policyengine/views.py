...
def exec_code(policy, action, code, wrapperStart, wrapperEnd, globals=None):
    _locals = locals()
...
def filter_policy(policy, action):
    ...
    exec_code(policy, action, policy.filter, wrapper_start, wrapper_end, None)
...
def initialize_policy(policy, action):
    ...
    exec_code(policy, action, policy.initialize, wrapper_start, wrapper_end, _globals)
...
def check_policy(policy, action):
    ...
    exec_code(policy, action, policy.check, wrapper_start, wrapper_end, None)
...
def notify_policy(policy, action):
    ...
    exec_code(policy, action, policy.notify, wrapper_start, wrapper_end, None)
...
def pass_policy(policy, action):
    ...
    exec_code(policy, action, policy.success, wrapper_start, wrapper_end, None)
...
def fail_policy(policy, action):
    ...
    exec_code(policy, action, policy.fail, wrapper_start, wrapper_end, None)

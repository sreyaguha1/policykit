...
def exec_code(policy, action, users, code, wrapperStart, wrapperEnd, globals=None, locals=None):
...
def filter_policy(policy, action, users):
    ...
    exec_code(policy, action, users, policy.filter, wrapper_start, wrapper_end, None, _locals)
...
def initialize_policy(policy, action):
    ...
    exec_code(policy, action, users, policy.initialize, wrapper_start, wrapper_end, _globals, _locals)
...
def check_policy(policy, action):
    ...
    exec_code(policy, action, users, policy.check, wrapper_start, wrapper_end, None, _locals, users)
...
def notify_policy(policy, action):
    ...
    exec_code(policy, action, users, policy.notify, wrapper_start, wrapper_end, None, _locals, users)
...
def pass_policy(policy, action):
    ...
    exec_code(policy, action, users, policy.success, wrapper_start, wrapper_end, None, _locals, users)
...
def fail_policy(policy, action):
    ...
    exec_code(policy, action, users, policy.fail, wrapper_start, wrapper_end, None, _locals, users)

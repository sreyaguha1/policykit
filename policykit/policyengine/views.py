...
def filter_policy(policy, action):
    ...
    exec_code(policy, action,policy.filter, wrapper_start, wrapper_end, None, _locals)
...
def initialize_policy(policy, action):
    ...
    exec_code(policy, action, policy.initialize, wrapper_start, wrapper_end, _globals, _locals)

...
def exec_code(policy, action, code, wrapperStart, wrapperEnd, globals=None, locals=None, users):
...
def filter_policy(policy, action):
    ...
    exec_code(policy, action, policy.filter, wrapper_start, wrapper_end, None, _locals, users)
...
def initialize_policy(policy, action):
    ...
    exec_code(policy, action, policy.initialize, wrapper_start, wrapper_end, _globals, _locals, users)
...
def check_policy(policy, action):
    ...
    exec_code(policy, action, policy.check, wrapper_start, wrapper_end, None, _locals, users)
...
def notify_policy(policy, action):
    ...
    exec_code(policy, action, policy.notify, wrapper_start, wrapper_end, None, _locals, users)
...
def pass_policy(policy, action):
    ...
    exec_code(policy, action, policy.success, wrapper_start, wrapper_end, None, _locals, users)
...
def fail_policy(policy, action):
    ...
    exec_code(policy, action, policy.fail, wrapper_start, wrapper_end, None, _locals, users)
